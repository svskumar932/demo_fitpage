...
//       expect(appState.tradingSignalState, TradingSignalState.initialState());
//     });
//
...
//     //   expect(appState.tradingSignalState.signals[0].name, equals('Name test'));
//     //   expect(appState.tradingSignalState.signals[0].tag, equals('Tag test'));
//     //   expect(
//     //       appState.tradingSignalState.signals[0].color, equals('Colour test'));
